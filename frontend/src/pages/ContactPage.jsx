    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <p className="text-center text-gray-600 mb-12">
          Имате въпроси, предложения или обратна връзка? Ще се радваме да чуем от вас!
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center text-gray-700">
            <h3 className="text-2xl font-semibold mb-4">Информация за контакт</h3>
            <p className="mb-4">
              Имейл:{" "}
              <a
            ...
            <p className="mb-4">Адрес: ул. Зелена 123, Еко град, Планета Земя</p>
            <div className="mt-6">
              <h4 className="font-semibold mb-2">Последвайте ни</h4>
